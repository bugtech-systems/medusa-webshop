...
export class Migration20260417203409 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "action_relation" ("id" text not null, "label" text not null, "description" text null, "status" text null, "model_id" text null, "action_id" text null, "metadata" jsonb null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "action_relation_pkey" primary key ("id"));`);
