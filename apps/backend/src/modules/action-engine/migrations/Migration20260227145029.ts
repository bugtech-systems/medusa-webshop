...
export class Migration20260227145029 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "action_view" ("id" text not null, "label" text not null, "type" text null, "handle" text null, "action_id" text null, "metadata" jsonb null, "configuration" jsonb null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "action_view_pkey" primary key ("id"));`);
