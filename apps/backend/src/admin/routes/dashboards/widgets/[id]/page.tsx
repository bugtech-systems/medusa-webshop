...
const MIMSVendorOrdersPage = () => {
  ...
  return (
    <Container>
      ...
      {/* Stats Cards Grid - Replacing Card component */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 px-6 py-4">
        ...
        <StatsCard 
          ...
          icon={<StatusBadge color="blue">Processing</StatusBadge>}
          badge="Processing"
          color="blue"
        />
        <StatsCard 
          label="Pending" 
          value={pendingOrders} 
          icon={<StatusBadge color="orange">Pending</StatusBadge>}
          badge="Pending"
          color="orange"
        />
        <StatsCard 
          ...
          value={totalQuantity} 
          icon={<DocumentText className="w-8 h-8" />}
          badge={`${totalQuantity} units`}
          color="green"
        />
      </div>

      {/* Status Tabs */}
      <div className="px-6 py-2 border-b border-ui-border-base">
