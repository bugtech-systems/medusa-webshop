      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            { store?.metadata?.social_facebook_url &&  
              <a
                href={store?.metadata?.social_facebook_url}
...
{store?.metadata?.social_x_url &&
              <a
                href={store?.metadata?.social_x_url}
              ...
              {store?.metadata?.social_instagram_url &&
              <a
                href={store?.metadata?.instagram}
           ...
           {store?.metadata?.social_linkedin_url &&  
           <a
                href={store?.metadata?.social_linkedin_url}
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <Link className="ease-out duration-200 hover:text-blue" href="/account">
                  My Account
                </Link>
              </li>
              <li>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by {store.name}.
            </p>
